...
export default function PrivateLayout() {
      ...
      <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-primary/5 to-accent/5 px-4">
        <div className="flex flex-col items-center gap-4 animate-fade-in">
          <div className="relative">
            ...
            <div className="absolute inset-0 m-auto w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-accent/30 animate-pulse" />
          </div>
          <div className="text-center space-y-1">
            <p className="text-sm sm:text-base font-medium text-foreground/80">Cargando perfil...</p>
            <p className="text-xs sm:text-sm text-muted-foreground">Por favor espera un momento</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-primary/5 to-accent/5 flex animate-fade-in">
      ...
      <main className="flex-1 ml-0 lg:ml-72 p-4 sm:p-6 md:p-8 lg:p-10 animate-slide-up transition-all duration-300">
